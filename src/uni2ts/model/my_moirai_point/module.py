...
class MoiraiModule(
    ...
    def replace_forecast_head(self, seq_len, pred_len):
        ...
        self.head_dropout = nn.Dropout(p=0.2, inplace=False)
    ...
    def forward(
        ...
        pred = self.head_fc1(reprs.flatten(1))
        pred = self.head_dropout(pred)
        pred = self.head_fc2(pred)
        return pred
